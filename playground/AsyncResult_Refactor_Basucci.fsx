...
type IWeb =
    ...
    // FIXME:
    abstract GetShippingRequired: RawLineItem -> Async<Result<bool,DomainError>>
...
module RawLineItem = 
    ...
    // Implementation for abstract GetShippingRequired
    let getShippingRequired (creds: Creds) (productId: RawLineItem) = 
        asyncResult {
            return Ok true
        }
...
module RawProduct = 
    ...
    //NOTE: I don't want to get a dependency into "create"
    // Now let's continute below.
    let create rawLineItem shippingRequired = 
        {
            Data = rawLineItem
